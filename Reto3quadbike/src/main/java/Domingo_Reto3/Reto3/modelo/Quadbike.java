...
public class Quadbike implements Serializable {
    ...
    // No se puede colocar solo id aunque en categoria se llame id ya que no
    // pueden haber en todo el programa 2 columnas id que se llamen igual, en
    // este caso solo la columna de Quadbike se puede llamar id
